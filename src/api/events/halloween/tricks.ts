export const standard = [
    ...
    'Lights out: Bebop games blind for 30 seconds!',
    'Truth or dare: Dare Bebop & Rook to do something in game, or ask them a question they have to answer truthfully',
    ...
    'Dark deeds: Rook has to praise choya erp.',
    ...
    'Group morale: Rook will queue up a song of your choice',
    'Demonic possession: Rook dabs. This is obviously out of her control.',
    'Inventory horror: Rook & Bebop\'s in game inventory is too full. They better dump two items.',
];
